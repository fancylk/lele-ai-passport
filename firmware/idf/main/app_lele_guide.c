...
typedef struct {
    ...
    const char *food;    // 好吃的
    const char *quiz;    // 考题
    const char *poem2;   // 第二页:相关诗词名句
    const char *story2;  // 第二页:典故补充
} spot_info_t;
...
static const spot_info_t SPOTS[] = {
    ...
    {"夫子庙", "南京", "旧时王谢堂前燕",
     ...
     "江南贡院考的是什么？",
     "烟笼寒水月笼沙，夜泊秦淮近酒家——杜牧",
     "乌衣巷曾是王导谢安两家大宅，刘禹锡叹：旧时王谢堂前燕，飞入寻常百姓家。"},
    {"中华门瓮城", "南京", "千里澄江似练",
     ...
     "敌人进了瓮城会怎么样？",
     "三山半落青天外，二水中分白鹭洲——李白",
     "传说城墙总塌，把富商沈万三的聚宝盆埋进地基才建成，从此叫聚宝门。"},
    // ---- 洛阳 ----
    {"白马寺", "洛阳", "白马驮经自宛延",
     ...
     "中国第一座官办寺院是哪座？",
     "白马驮经事已空，断碑残刹见遗踪——张继",
     "两位高僧在这里译出第一部汉文佛经《四十二章经》，白马寺是佛教传入中国的祖庭。"},
    {"龙门石窟", "洛阳", "谁家玉笛暗飞声",
     ...
     "卢舍那大佛有多高？",
     "若问古今兴废事，请君只看洛阳城——司马光",
     "大诗人白居易晚年隐居香山，自称香山居士，去世就葬在龙门，白园至今游人不断。"},
    // ---- 西安 ----
    {"秦始皇兵马俑", "西安", "秦王扫六合",
    ...
    {"西安城墙", "西安", "长乐安定永宁安",
     ...
     "西安城墙周长多少公里？",
     "长安大道连狭斜，青牛白马七香车——卢照邻",
     "城墙西南角是圆的——那里原是唐朝皇城的角楼，明城墙直接接了上去。"},
    // ---- 渭南 ----
    {"华山西峰", "渭南", "举头红日近",
     ...
     "《咏华山》是谁几岁写的？",
     "只有天在上，更无山与齐——寇准《咏华山》",
     "自古华山一条路：千尺幢、百尺峡、苍龙岭，古人手脚并用才爬得上顶。"},
    // ---- 三门峡 ----
    {"函谷关", "三门峡", "天开函谷壮关中",
     ...
     "《道德经》是谁在哪写的？",
     "上善若水，水善利万物而不争——《道德经》",
     "关令尹喜苦留老子住下，才有了五千言《道德经》，这里被尊为道家之源。"},
    {"陕州地坑院", "三门峡", "见树不见村",
     ...
     "地坑院院子中间为什么种树？",
     "结庐在人境，而无车马喧——陶渊明",
     "窑洞常年恒温十八九度，号称天然空调，剪纸手艺被称为民俗活化石。"},
    {"三门峡大坝", "三门峡", "黄河之水天上来",
    ...
    {"清明上河园", "开封", "暖风熏得游人醉",
     ...
     "《清明上河图》是谁画的？",
     "直把杭州作汴州——林升《题临安邸》",
     "原画里有500多个人物、28艘船，连算账伙计的表情都画得清清楚楚。"},
    {"鼓楼夜市", "开封", "夜市直至三更尽",
    ...
    {"龙亭公园", "开封", "王师北定中原日",
     ...
     "潘杨二湖哪个清哪个浑？",
     "八荒争凑，万国咸通——《东京梦华录》",
     "开封城下摞着六座古城，城摞城景观全世界独一份，龙亭就是最上层的皇宫。"},
};
