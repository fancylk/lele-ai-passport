...
void demo_lele_guide_enter(void); void demo_lele_guide_exit(void);
...
void demo_catch_enter(void); void demo_catch_exit(void);
void demo_catch_key(bsp_btn_t btn, bsp_btn_ev_t ev);

void demo_answer_enter(void); void demo_answer_exit(void);
